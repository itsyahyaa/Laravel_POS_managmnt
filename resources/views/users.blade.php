        ...
        <div class="container-fluid">
            ...
            <div class="card card-success">
                <div class="card-header border-0">
                    ...
                    <div class="col-md-6"><h6 class="card-title"><b>CUSTOMER FORM</b></h6></div>
                        <div class="col-md-5"></div>
                    </div>
                </div>
                <!-- /.card-header -->
                                        ...
                                        <table class="table bg-white rounded shadow-sm  table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#" class="btn btn-info btn-sm"><i class="fas fa-edit" data-bs-toggle="modal" data-bs-target="#edit{{ $user->id }}"> Edit</i></a>
                                                            <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-trash" data-bs-toggle="modal" data-bs-target="#delete{{ $user->id }}"> Delete</i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                {{-- Edit User Modal --}}
